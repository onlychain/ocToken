...
import org.onlychain.exceptions.MessageDecodingException;
import org.onlychain.exceptions.MessageEncodingException;
...
public final class OcMath {
    ...
    public static String hexStringToText(String input) {
      return new String(OcMath.hexStringToByteArray(input), StandardCharsets.UTF_8);
    }
